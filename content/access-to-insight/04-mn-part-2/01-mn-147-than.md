---
title: Cula-Rahulovada Sutta — The Shorter Exposition to Rahula
slug: mn-147-than
order: 1
author: Thanissaro Bhikkhu
nikaya: MN
year: '2006'
source_url: https://www.accesstoinsight.org/tipitaka/mn/mn.147.than.html
license: CC-BY-NC
---
...
1.
    The Buddha's basic approach in this discourse is to take a line of questioning that he usually applies to the five aggregates (see [SN 22.59](<../sn/sn22/sn22.059.than.html>)) and to apply it to the framework of the six sense media as given in [SN 35.28](<../sn/sn35/sn35.028.than.html>). This phrase, however, is the one point where this sutta deviates from that framework. The corresponding phrase in [SN 35.28](<../sn/sn35/sn35.028.than.html>) focuses exclusively on feelings. The passage here — _vedanagatam, saññagatam, sankharagatam, viññanagatam_ — focuses on all four mental aggregates. For another example of translating _–gatam_ as "mode," see the phrase "mode of perception" _(saññagatam)_ in [MN 121](<mn.121.than.html>). 

See also: [MN 61](<mn.061.than.html>); [MN 62](<mn.062.than.html>).
