---
title: Kevatta (Kevaddha) Sutta — To Kevatta
slug: dn-11-0-than
order: 4
author: Thanissaro Bhikkhu
nikaya: DN
year: '1997'
source_url: https://www.accesstoinsight.org/tipitaka/dn/dn.11.0.than.html
license: CC-BY-NC
---
...
1.
    _Viññanam anidassanam._ This term is nowhere explained in the Canon, although MN 49 mentions that it "does not partake in the allness of the All" — the "All" meaning the six internal and six external sense media (see [SN 35.23](<../sn/sn35/sn35.023.than.html>)). In this it differs from the consciousness factor in dependent co-arising, which is defined in terms of the six sense media. Lying outside of time and space, it would also not come under the consciousness-aggregate, which covers all consciousness near and far; past, present, and future. However, the fact that it is outside of time and space — in a dimension where there is no here, there, or in between ([Ud 1.10](<../kn/ud/ud.1.10.than.html>)), no coming, no going, or staying ([Ud 8.1](<../kn/ud/ud.8.01.than.html>)) — means that it cannot be described as permanent or omnipresent, terms that have meaning only within space and time. The standard description of nibbana after death is, "All that is sensed, not being relished, will grow cold right here." (See [MN 140](<../mn/mn.140.than.html>) and [Iti 44](<../kn/iti/iti.2.028-049.than.html#iti-044>).) Again, as "all" is defined as the sense media, this raises the question as to whether consciousness without feature is not covered by this "all." However, [AN 4.174](<../an/an04/an04.174.than.html>) warns that any speculation as to whether anything does or doesn't remain after the remainderless stopping of the six sense media is to "objectify non-objectification," which gets in the way of attaining the non-objectified. Thus this is a question that is best put aside.
2.
    This passage also appears at [AN 6.54](<../an/an06/an06.054.olen.html#shore>). — _Ed._
